...
public class MuteCommand extends CommandBase {
    ...
    public void execute(ProxiedPlayer player, String[] args) {
        ...
        long muteLength = parsePeriod(lengthStr) / 1000;
    ...
    public static long parsePeriod(String period) {
        ...
        while (matcher.find()) {
            ...
            switch (type) {
                case "h": totalSeconds += num * 3600L; break;
                case "d": totalSeconds += num * 86400L; break;
                case "w": totalSeconds += num * 604800L; break;
                case "m": totalSeconds += num * 60L; break;
                case "y": totalSeconds += num * 31536000L; break;
            }
        }
